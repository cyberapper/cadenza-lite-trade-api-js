...
export namespace CadenzaClient {
  ...
  export import HealthRetreiveResponse = API.HealthRetreiveResponse;
  ...
  export import QuoteExecutionReport = API.QuoteExecutionReport;
  export import QuoteWithOrderCandidates = API.QuoteWithOrderCandidates;
  export import TradingFetchQuotesResponse = API.TradingFetchQuotesResponse;
  export import TradingListOrdersResponse = API.TradingListOrdersResponse;
  export import TradingPlaceOrderResponse = API.TradingPlaceOrderResponse;
  export import TradingCancelOrderParams = API.TradingCancelOrderParams;
  export import TradingFetchQuotesParams = API.TradingFetchQuotesParams;
  export import TradingGetQuoteExecutionReportParams = API.TradingGetQuoteExecutionReportParams;
  export import TradingListOrdersParams = API.TradingListOrdersParams;
  export import TradingPlaceOrderParams = API.TradingPlaceOrderParams;

  export import Portfolio = API.Portfolio;
  export import ExchangeBalance = API.ExchangeBalance;
  export import ExchangePosition = API.ExchangePosition;
