...
```sh
npm install git+ssh://git@github.com:cyberapper/cadenza-lite-sdk-js.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainlessapi.com/docs/guides/publish), this will become: `npm install cadenza-sdk`
...
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/cyberapper/cadenza-lite-sdk-js/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/cyberapper/cadenza-lite-sdk-js/issues) with questions, bugs, or suggestions.
